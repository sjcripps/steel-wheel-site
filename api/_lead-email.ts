...
export async function syncWorkmateCrm(opts: {
  ...
  name?: string;
  phone?: string;
  source: 'swl-rate-quote' | 'swl-demurrage' | 'swl-transload' | 'swl-rail-vs-truck' | 'swl-rail-served-businesses' | 'swl-commodity-flow' | 'swl-course-signup' | 'swl-lease-vs-buy' | 'swl-sublease';
  tags?: string[];
